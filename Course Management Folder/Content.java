                ...
                frameAdd.update.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent actionEvent) {
                        ...
                        if (decide == 0) {
                            ...
                            if(bool==true&&Integer.parseInt(new Integer(frameAdd.getCreditField()).toString())<0){
                                JOptionPane.showMessageDialog(null,"Credit is equal or grater than 0, try again!");
                            }
                            else  if(bool==true) {
                                ...
                                frameUpdate.update.addActionListener(new ActionListener() {
                                    ...
                                    public void actionPerformed(ActionEvent actionEvent) {
                                        ...
                                        if (decide3 == 3) {
                                            boolean bool=true;
                                            try{
                                                Integer.parseInt(new Integer(frameUpdate.getCreditField()).toString());
                                            }
                                            catch (NumberFormatException e){
                                                bool=false;
                                            }
                                            if(bool==true&&Integer.parseInt(new Integer(frameUpdate.getCreditField()).toString())<0){
                                                JOptionPane.showMessageDialog(null,"Credit is equal or grater than 0, try again!");
                                            }
                                            else  if(bool==true) {
                                                if(frameUpdate.getNameField().equals("")||frameUpdate.getCodeField().equals("")||frameUpdate.getLecturerField().equals("")){
                                                    ...
                                                    output96.add(new Course(frameUpdate.getNameField(), frameUpdate.getCodeField(), frameUpdate.getCreditField(), frameUpdate.getLecturerField()));
                                                    TestSerializeCourse test = new TestSerializeCourse(output96);
                                                    frameUpdate.setNameField("");
                                                    frameUpdate.setCodeField("");
                                                    frameUpdate.setCreditField(0);
                                                    frameUpdate.setLecturerField("");
                                                    frameUpdate.frame.add(frameUpdate.avatar);
                                                    frameUpdate.avatar.setText("Done!");
                                                }
                                            }else{
                                                JOptionPane.showMessageDialog(null,"Credits must be a number, do it again!");
                                            }
