            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                frameUpdate.back.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent actionEvent) {
                        ...
                        System.out.println("Tran Thi Thuy Kieu BI7-088");
                                        ...
                                        if (decide3 == 3) {
                                            ...
                                            if(bool==true&&Integer.parseInt(new Integer(frameUpdate.getCreditField()).toString())<0){
                                                ...
                                                if(frameUpdate.getNameField().equals("")||frameUpdate.getCodeField().equals("")||frameUpdate.getLecturerField().equals("")){
                                                    ...
                                                    output.add(new Course(frameUpdate.getNameField(), frameUpdate.getCodeField(), frameUpdate.getCreditField(), frameUpdate.getLecturerField()));
                                                    TestSerializeCourse test = new TestSerializeCourse(output);
                                                    frameUpdate.setNameField("");
